...
print ("Enter Cheff Name or % to display all Cheff Name : ")
inputstring = input()
...
args=mycursor.callproc('proc_dispcheff',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Cheff No','Cheff Name'], tablefmt='psql'))
