...
print ("Enter Cashier Name or % to display all Cashier Name : ")
inputstring = input()
...
args=mycursor.callproc('proc_dispcashier',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Cashier No','Cashier Name'], tablefmt='psql'))
