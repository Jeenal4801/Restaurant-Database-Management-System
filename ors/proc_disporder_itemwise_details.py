...
args=mycursor.callproc('proc_disporder_itemwise',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Item Name','Order Date','Cust. Name','Qty','Price'], tablefmt='psql'))
