      ...
      # call Order foam
       ...
       # call Proc Itemdetail foam
        def proc_itemdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_itemdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_itemdetails.py'))
        def proc_customerdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_customerdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_customerdetails.py'))
        def proc_managerdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_customerdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_managerdetails.py'))
        def proc_waiterdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_waiterdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_waiterdetails.py'))
        def proc_cheffdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_cheffdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_cheffdetails.py'))
        def proc_cashierdetails():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_cashierdetails.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_cashierdetails.py'))

        def proc_disporder_mgrwise_report():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_disporder_mgrwise_details.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_disporder_mgrwise_details.py'))
   
        def proc_disporder_itemwise_report():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_disporder_itemwise_details.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_disporder_itemwise_details.py'))

        def proc_disporder_custwise_report():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_disporder_custwise_details.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_disporder_custwise_details.py'))

        def proc_disporder_custwise_total_report():
            #os.system('%s %s' % (py,'D:\Python\Python37-32\python proc_disporder_custwise_total_details.py'))
            os.system('%s %s' % ('D:\Python\Python37-32\pythonw.exe "D:\Python\Python37-32\Lib\idlelib\idle.pyw"','proc_disporder_custwise_total_details.py'))
...
#creating table
        ...
        def check():
                    ...
                    # Procedure - Button
                    self.button = Button(self, text='Disp.Item', width=20,bg='yellow', font=('Courier new', 10), command=proc_itemdetails).place(x=30,y=100)
                    self.button = Button(self, text='Disp. Customer', width=20,bg='yellow', font=('Courier new', 10), command=proc_customerdetails).place(x=30,y=125)
                    self.brt = Button(self, text="Disp. Manager", width=20,bg='yellow', font=('Courier new', 10), command=proc_managerdetails).place(x=30, y=150)
                    self.brt = Button(self, text="Disp. Waiter", width=20,bg='yellow', font=('Courier new', 10), command=proc_waiterdetails).place(x=30, y=175)
                    self.button = Button(self, text='Disp.Cheff', width=20,bg='yellow', font=('Courier new', 10), command=proc_cheffdetails).place(x=30,y=200)
                    self.button = Button(self, text='Disp. Cashier', width=20,bg='yellow', font=('Courier new', 10), command=proc_cashierdetails).place(x=30,y=225)
                    self.brt = Button(self, text="Managerwise Order", width=20,bg='yellow', font=('Courier new', 10), command=proc_disporder_mgrwise_report).place(x=30, y=250)
                    self.brt = Button(self, text="Itemwise Order", width=20,bg='yellow', font=('Courier new', 10), command=proc_disporder_itemwise_report).place(x=30, y=275)
                    self.brt = Button(self, text="Customerwise Order", width=20,bg='yellow', font=('Courier new', 10), command=proc_disporder_custwise_report).place(x=30, y=300)
                    self.brt = Button(self, text="Cust.wise Total Order", width=20,bg='yellow', font=('Courier new', 10), command=proc_disporder_custwise_total_report).place(x=30, y=325)
