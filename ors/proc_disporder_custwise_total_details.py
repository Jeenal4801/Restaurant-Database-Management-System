...
print ("Enter Customer ID :  [% for All Customer ]  ")
inputstring = input()
...
args=mycursor.callproc('proc_disporder_custwise_total',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Cust. Name', 'Tot. Qty','Tot. Price'], tablefmt='psql'))
