...
class Rem(Tk):
    def __init__(self):
        ...
        self.listTree.heading("#0", text='Waiter ID')
        ...
        def ser():
             try:
                ...
                cursor.execute("Select * from waiter order by idno")
                pc = cursor.fetchall()
                if pc:
                    ...
                    messagebox.showinfo("Error", "No Waiter...!")
             except Error:
                #print(Error)
        ...
        def check():
                    ...
                    # Customer - Button
                    self.button = Button(self, text='View Waiter(s)', width=20,bg='pink', font=('Courier new', 10), command=ser).place(x=200,y=250)
