...
print ("Managerwise Order Details")
print ("=========================================")
...
args=mycursor.callproc('proc_disporder_mgrwise',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Mgr Name','Order Date','Cust. Name','Item Name', 'Qty','Price'], tablefmt='psql'))
