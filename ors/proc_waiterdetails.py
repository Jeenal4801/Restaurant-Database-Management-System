...
print ("Enter Waiter Name or % to display all Waiter Name : ")
inputstring = input()
...
args=mycursor.callproc('proc_dispwaiter',(inputstring,))
# print ("args : ", args)
...
#    print(tabulate(result, tablefmt='psql'))
    print(tabulate(result, headers=['Waiter No','Waiter Name'], tablefmt='psql'))
